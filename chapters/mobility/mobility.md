...
However, HIP requires deployment of new protocol machinery at both endpoints and introduces compatibility challenges with existing middleboxes, including cryptographic identifiers and modified stack behavior. As with many clean-slate refinements to Internet architecture, its adoption has remained limited.
\linebreak
